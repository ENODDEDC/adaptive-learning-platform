...
const TeacherAssignmentModal = ({ isOpen, onClose, assignment, courseId, onUpdate }) => {
  ...
  const modalContent = (
    <>
      ...
      <div
        className="fixed inset-0 z-[9999] bg-black/60 backdrop-blur-md animate-blur-in"
        onClick={onClose}
      />
      ...
      <div className="fixed inset-0 z-[10000] flex items-center justify-center p-4 sm:p-8 pointer-events-none">
        <div className="w-full max-w-4xl bg-white rounded-2xl shadow-2xl flex flex-col max-h-[90vh] pointer-events-auto animate-scale-in origin-center">
          <div className="flex-1 flex flex-col overflow-hidden">

            {/* Immersive Header */}
            <div className="flex-shrink-0 px-8 py-6 border-b border-gray-100 bg-white rounded-t-2xl">
              <div className="flex items-start justify-between mb-6">
                <div className="flex-1 pr-4">
                  <h2 className="text-3xl font-bold text-gray-900 mb-3 leading-tight">{assignment.title}</h2>
                  {assignment.dueDate && (
                ...
                <button
                  onClick={onClose}
                  className="flex-shrink-0 p-2.5 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-xl transition-all hover:rotate-90 duration-300"
                  title="Close (ESC)"
                >
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className={`px-6 py-3 font-semibold text-sm transition-all rounded-xl ${activeTab === 'details'
                ...
                <button
                  ...
                  className={`px-6 py-3 font-semibold text-sm transition-all rounded-xl flex items-center gap-2 ${activeTab === 'submissions'
                      ? 'bg-gray-900 text-white shadow-lg shadow-gray-900/20'
                      : 'text-gray-600 hover:bg-gray-50'
                    }`}
                >
                  Submissions
                  <span className={`px-2 py-0.5 rounded-lg text-xs font-bold ${activeTab === 'submissions' ? 'bg-white/20 text-white' : 'bg-gray-200 text-gray-700'
                    }`}>
              ...
              {activeTab === 'details' && (
                <div className="p-6 space-y-6">
                  ...
                  {assignment.attachments && assignment.attachments.length > 0 && (
                    <div>
                      <h3 className="text-xs font-semibold text-gray-500 mb-3 uppercase tracking-wider">Attachments</h3>
