    ...
    >
      ...
      {animationPhase !== 'entering' && (
        <div
          ...
          style={{
            ...
            boxShadow: '0 0 0 8px rgba(139,92,246,0.15)',
            borderRadius: '50%',
      ...
      {animationPhase === 'callout' && (
        ...
        >
          ...
          {/* Callout */}
          <div className="relative rounded-xl border border-white/10 bg-gray-900 shadow-2xl p-4 text-white">
            {/* Pointer */}
            <div
              className="absolute w-3 h-3 bg-gray-900 border-l border-t border-white/10 rotate-45"
              style={{
                left: -7,
                top: '50%',
                marginTop: -6
            ...
            <button
              onClick={onDismiss}
              className="absolute top-2 right-2 p-1 rounded-md text-gray-400 hover:text-gray-200 hover:bg-white/10 transition-colors"
            >
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-2.5 pr-5">
                <div className="mt-0.5 flex h-8 w-8 items-center justify-center rounded-lg bg-white/10 text-base">
                  {modeContent.icon}
                </div>
                <div>
                  <h3 className="text-sm font-semibold text-white">{modeContent.title}</h3>
                  <p className="text-xs text-gray-400">You seem interested in this section</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2 pt-1">
                <button
                  ...
                  className="inline-flex items-center gap-1.5 rounded-md bg-violet-600 px-3 py-2 text-xs font-semibold text-white hover:bg-violet-500 transition-colors"
                >
                ...
                <button
                  onClick={onDismiss}
                  className="px-2 py-2 text-xs font-medium text-gray-400 hover:text-gray-200 transition-colors"
                >
                  Dismiss
                </button>
              </div>
