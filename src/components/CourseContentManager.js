          ...
          <div className="p-6 bg-white border border-gray-200 shadow-sm rounded-2xl">
            {loading ? (
              ...
              <div className="py-12 text-center">
                ...
                <h3 className="mb-2 text-lg font-medium text-gray-900">No content found</h3>
              ...
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                {filteredContent.map((content) => {
                  ...
                  return (
                    <div key={content.id} className="p-6 transition-all duration-200 border border-gray-200 bg-gray-50 rounded-xl hover:border-gray-300">
                      {/* Content Header */}
                      ...
                      {/* Content Info */}
                      <div className="mb-4">
                        <h3 className="mb-1 font-semibold text-gray-900 line-clamp-2">{content.title}</h3>
                        {content.description && (
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="flex items-center justify-center flex-1 gap-2 px-3 py-2 text-sm text-white transition-colors bg-blue-600 rounded-lg hover:bg-blue-700"
                        >
                        ...
                        <a
                          ...
                          download
                          className="flex items-center justify-center p-2 text-gray-600 transition-colors bg-gray-200 rounded-lg hover:bg-gray-300"
                        >
